...
const UploadArtWork = () => {
  ...
  const { uploadART } = useMethodsContext();
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      await uploadART(id, res.data.IpfsHash, price, category);
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4">
      <div className="text-center p-4 font-bold text-2xl">Upload your File</div>
      <p className="text-center mb-0 py-4 text-red-400">
        By Uploading You are agreeing to stake 100 Community Tokes for approval
      </p>
